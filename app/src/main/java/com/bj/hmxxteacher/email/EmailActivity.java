...
//    private List<Letter.DataBean.ListDataBean> dataList1 = new ArrayList<>();//未读
//    private List<Letter.DataBean.ListDataBean> dataList2 = new ArrayList<>();//已读
//    private List<Letter.DataBean.ListDataBean> dataList3 = new ArrayList<>();//已回复
//    private List<Letter.DataBean.ListDataBean> dataList4 = new ArrayList<>();//星标
